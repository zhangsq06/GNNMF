...
parser.add_argument('--bed', default='GSE170652',type=str,help='The prefix name of the bed file')
parser.add_argument('--path', default='../testdata/',type=str,help='Path to the bed file') #contain hg38.fa GSE.bed GSE.bam  path/
...
def get_data(args):
    ...
    for i in range(2):
        ...
        os.system(cmd)
        path_encode = '../data/encode_'  + str(args.peak_flank * 2 + 1)
