...
parser.add_argument('--dataset', default='GSE169772_encode',type=str,help='The prefix name of the dataset')
...
def motif_task(args):
	...
	test_aucs=[]
	preds, labels,seq_hidden, kmer_hidden,test_auc = one_task(args.dataset,Kmers,adjs_0, adjs_1,adjs_2, adj3, idx_train, idx_val, idx_test, idx_all, labels, options, True)
